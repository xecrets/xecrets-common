...
public class Texts
{
    ...
    public static string LabelNo => T[nameof(Resources.ButtonNo)].MenuToLabelText();
    public static string LabelOk => T[nameof(Resources.ButtonOk)].MenuToLabelText();
    public static string LabelTheSecret => T[nameof(Resources.LabelTheSecret)];
    public static string LabelYes => T[nameof(Resources.ButtonYes)].MenuToLabelText();
