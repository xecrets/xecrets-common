...
/// <summary>
/// Represents the folders a user has granted the app repeated access to.
/// </summary>
public sealed class WorkFolders
{
    /// <summary>
    /// Gets or sets the folders, in the user's chosen order.
    /// </summary>
