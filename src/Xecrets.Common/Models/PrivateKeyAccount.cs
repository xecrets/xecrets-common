...
/// <summary>
/// Represents the collection of encrypted key pairs belonging to a single user account.
/// </summary>
public sealed class PrivateKeyAccount
{
    /// <summary>
    /// Gets or sets the encrypted key pairs belonging to this account.
    /// </summary>
    [JsonPropertyName("keys")]
    public List<EncryptedPrivateKey> Keys { get; set; } = [];

    /// <summary>
    /// Gets or sets the email address identifying this account.
    /// </summary>
