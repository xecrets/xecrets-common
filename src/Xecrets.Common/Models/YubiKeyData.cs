...
/// <summary>
/// Represents a single YubiKey slot configured to protect an encrypted password.
/// </summary>
public sealed class YubiKeyData
{
    /// <summary>
    /// Gets or sets the serial number of the YubiKey.
    /// </summary>
    [JsonPropertyName("serialNumber")]
    public string SerialNumber { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the identifier of the configured slot on the YubiKey.
    /// </summary>
    [JsonPropertyName("slot")]
    public string Slot { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets how this slot is used to protect the password.
    /// </summary>
    [JsonPropertyName("mode")]
    [JsonConverter(typeof(JsonStringEnumConverter<ProtectionMode>))]
    public ProtectionMode Mode { get; set; } = ProtectionMode.Uninitialized;

    /// <summary>
    /// Gets or sets the password, encrypted using this YubiKey slot.
    /// </summary>
