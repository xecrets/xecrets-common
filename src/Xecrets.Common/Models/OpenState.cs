...
/// <summary>
/// Represents the files a user currently has open and the files most recently used.
/// </summary>
public sealed class OpenState
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the UTC timestamp of the last time this state was written.
    /// </summary>
    [JsonPropertyName("lastWriteUtc")]
    public DateTime LastWriteUtc { get; set; }

    /// <summary>
    /// Gets or sets the files currently open for encryption or decryption.
    /// </summary>
    [JsonPropertyName("open")]
    public List<OpenFilePairState> OpenFiles { get; set; } = [];
