...
/// <summary>
/// Defines a transient data source that provides a value of type <typeparamref name="T"/>.
/// </summary>
...
public interface IPersistentData<T>
{
    ...
    /// <summary>
    /// Creates an <see cref="IEditScope{T}"/> instance that will automatically save changes on disposal.
    /// </summary>
    /// <returns></returns>
    IEditScope<T> BeginEdit();
}
